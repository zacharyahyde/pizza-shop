...
class PizzasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pizza" do
    assert_difference('Pizza.count') do
      post pizzas_url, params: { pizza: { cost: @pizza.cost, crust: @pizza.crust, image: @pizza.image, name: @pizza.name, sauce: @pizza.sauce, topping: @pizza.topping } }
    end
  ...
  test "should update pizza" do
    patch pizza_url(@pizza), params: { pizza: { cost: @pizza.cost, crust: @pizza.crust, image: @pizza.image, name: @pizza.name, sauce: @pizza.sauce, topping: @pizza.topping } }
